...
class XlsReportBase():
    ...
    """
    InfoTrtFields = {'VTrts.DCMeas': ('DCMeas', 0, 0),
    ...
    InfoDCMeasFields = {'Time': ('Meas Date', 0, {}),
                        'Vds': ('Vds', 1, {'Vgs': -0.1,
                                           'Vds': None,
                                           'Ud0Norm': True}),
                        'Ud0': ('Ud0', 2, {'Vgs': -0.1,
    ...
    InfoACMeasFields = {'Time': ('Meas Date', 0, {}),
                        'Vrms': ('Vrms', 1, {'Vgs': -0.1,
                                             'Vds': None,
                                             'Ud0Norm': True})}
...
class GenXlsDeviceHistory(XlsReportBase):
...
if __name__ == "__main__":
    ...
    XlsHist = GenXlsDeviceHistory('../' +Name+'.xlsx', Conditions)
    XlsHist.GenFullReport()
    XlsHist.close()
