...
from PyQt5.QtWidgets import (QMessageBox, QFileDialog, QColorDialog,
                             QInputDialog, QDataWidgetMapper, QAction)
from PyQt5.QtCore import QCoreApplication
#import PyFET.AnalyzeData as FETAna
#import PyFET.DataStructures as FETData
#import PyFET.PlotDataClass as FETplt
from PyFET.PyFETRecord import NeoRecord, PltSlot, PlotRecord, threshold_detection


RecordExplorer_ui = "RecordExplorer2.ui"  # Enter file here.
Ui_RecordExplorer, QtBaseClass = uic.loadUiType(RecordExplorer_ui)


class RecordExplorer(QtWidgets.QMainWindow, Ui_RecordExplorer):
    ...
    def __init__(self):
        ...
        Ui_RecordExplorer.__init__(self)
        self.setupUi(self)
